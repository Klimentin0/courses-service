...
run-help:
	go run app/services/courses-api/main.go --help | go run app/tooling/logfmt/main.go
...
admin:
	go run app/tooling/courses-admin/main.go
...
dev-apply:
	kustomize build config/k8s/dev/database | kubectl apply -f -
