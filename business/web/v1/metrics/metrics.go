...
// safe to be aaccessed concurrently thanks to expvar. No extra abstraction is required.
type metrics struct {
...
// The metrics value is stored in a package level variable since everythign
